 ...
 * Use the {@link Flashcards#newInstance} factory method to
...
public class Flashcards extends Fragment {
    ...
    public static Flashcards newInstance(String param1, String param2) {
        Flashcards fragment = new Flashcards();
